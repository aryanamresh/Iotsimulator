...
def tgan (dataX, parameters, generate_flag=1):
    ...
    checkpoint_file = os.path.join(checkpoint_dir, parameters['checkpointFileName'])
    ...
    print("Normalization_Flag : ", Normalization_Flag);  #just to check
    ...
    #print("learning rate specified : ", lr)
    ...
    for itt in range(iterations):
        ...
        if (check_d_loss > 0.15):        
            ...
            step_d_loss = 0.15   # added by me , otherwise error was coming step_d_loss referenced before initializing
